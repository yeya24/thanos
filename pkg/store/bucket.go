...
type BlockSeriesSizeStrategy string

const (
	BlockSeriesSizeMax   BlockSeriesSizeStrategy = "max"
	BlockSeriesSizeP90   BlockSeriesSizeStrategy = "p90"
	BlockSeriesSizeP99   BlockSeriesSizeStrategy = "p99"
	BlockSeriesSizeP999  BlockSeriesSizeStrategy = "p999"
	BlockSeriesSizeP9999 BlockSeriesSizeStrategy = "p9999"
)
...
type BucketStore struct {
	...
	// series size estimation where no strict requirement to use max series size of the block.
