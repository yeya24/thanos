...
func NewTripperWare(
	...
	queryCacheMiddleware, _, err := queryrange.NewResultsCacheMiddleware(
		logger,
		queryrange.ResultsCacheConfig{CacheConfig: cortexcache.Config{EnableFifoCache: true, Fifocache: cortexcache.FifoCacheConfig{
			MaxSizeBytes: "10000",
			MaxSizeItems: 10000,
		}}, LegacyMaxCacheFreshness: limits.MaxCacheFreshness("")},
