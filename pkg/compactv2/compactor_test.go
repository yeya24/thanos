...
func TestCompactor_WriteSeries_e2e(t *testing.T) {
	...
	for _, tcase := range []struct {
		...
		{
			name: "1 blocks compact with offline dedup (no effect)",
			input: [][]seriesSamples{
				{
					{lset: labels.Labels{{Name: "a", Value: "a"}},
						chunks: [][]sample{{{0, 0}, {2, 1}, {3, 2}}}},
				},
			},
			mergeFunc: NewDedupChunkSeriesMerger(&tsdb.TimeRange{Min: 0, Max: 2}),
			expected: []seriesSamples{
				{lset: labels.Labels{{Name: "a", Value: "a"}},
					chunks: [][]sample{{{0, 0}, {2, 1}, {3, 2}}}},
			},
		...
		{
			name: "3 blocks compact with offline dedup",
			input: [][]seriesSamples{
				{
					{lset: labels.Labels{{Name: "a", Value: "a"}},
						chunks: [][]sample{{{0, 0}, {2, 1}, {3, 2}}}},
					{lset: labels.Labels{{Name: "a", Value: "b"}},
						chunks: [][]sample{{{2, 2}, {3, 3}, {4, 4}}}},
				},
				{
					{lset: labels.Labels{{Name: "a", Value: "a"}},
						chunks: [][]sample{{{5, 5}, {6, 6}, {7, 7}}}},
					{lset: labels.Labels{{Name: "a", Value: "b"}},
						chunks: [][]sample{{{1, 1}, {2, 2}, {3, 3}}}},
				},
				{
					{lset: labels.Labels{{Name: "a", Value: "a"}},
						chunks: [][]sample{{{5, 5}, {6, 66}}}},
					{lset: labels.Labels{{Name: "a", Value: "c"}},
						chunks: [][]sample{{{100, 1}, {300, 3}, {400, 4}}}},
				},
			},
			mergeFunc: NewDedupChunkSeriesMerger(&tsdb.TimeRange{Min: 0, Max: 400}),
			expected: []seriesSamples{
				{lset: labels.Labels{{Name: "a", Value: "a"}},
					chunks: [][]sample{{{0, 0}, {2, 1}, {3, 2}}, {{5, 5}, {6, 66}}}},
				{lset: labels.Labels{{Name: "a", Value: "b"}},
					chunks: [][]sample{{{1, 1}, {2, 2}, {3, 3}}}},
				{lset: labels.Labels{{Name: "a", Value: "c"}},
					chunks: [][]sample{{{100, 1}, {300, 3}, {400, 4}}}},
