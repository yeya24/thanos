...
func (qapi *QueryAPI) query(r *http.Request) (interface{}, []error, *api.ApiError) {
	...
	qry, err := qe.NewInstantQuery(qapi.queryableCreate(enableDedup, replicaLabels, storeDebugMatchers, nil, maxSourceResolution, enablePartialResponse, false), r.FormValue("query"), ts)
	if err != nil {
		return nil, nil, &api.ApiError{Typ: api.ErrorBadData, Err: err}
	}
...
func (qapi *QueryAPI) queryRange(r *http.Request) (interface{}, []error, *api.ApiError) {
	...
	qry, err := qe.NewRangeQuery(
		qapi.queryableCreate(enableDedup, replicaLabels, storeDebugMatchers, nil, maxSourceResolution, enablePartialResponse, false),
		r.FormValue("query"),
		start,
		end,
		step,
...
func (qapi *QueryAPI) labelValues(r *http.Request) (interface{}, []error, *api.ApiError) {
	...
	q, err := qapi.queryableCreate(true, nil, storeDebugMatchers, matcherSets, 0, enablePartialResponse, true).
...
func (qapi *QueryAPI) series(r *http.Request) (interface{}, []error, *api.ApiError) {
	...
	q, err := qapi.queryableCreate(enableDedup, replicaLabels, storeDebugMatchers, nil, math.MaxInt64, enablePartialResponse, true).
