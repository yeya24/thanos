...
func NewConfigWatcher(logger log.Logger, r promauto.Factory, path string, interval model.Duration) (*ConfigWatcher, error) {
	if logger == nil {
	...
	c := &ConfigWatcher{
		...
		lastSuccessTimeGauge: r.NewGauge(
			prometheus.GaugeOpts{
